        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                memo = _args.length > 10 && _args[10] !== undefined ? _args[10] : '';
                noBroadcast = _args.length > 11 && _args[11] !== undefined ? _args[11] : false;
                ...
                _context.next = 7;
                return this._bncClient._prepareTransaction(htltMsg, signHTLTMsg, from, null, memo);
