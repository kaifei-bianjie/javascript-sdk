...
declare class Swap {
     ...
     */
    HTLT(from: string, recipient: string, recipientOtherChain: string, senderOtherChain: string, randomNumberHash: string, timestamp: number, amount: Coin[], expectedIncome: string, heightSpan: number, crossChain: boolean, memo?: string, noBroadcast?: boolean): Promise<import("../..").Transaction | {
        result: any;
        status: number;
    }>;
    /**
